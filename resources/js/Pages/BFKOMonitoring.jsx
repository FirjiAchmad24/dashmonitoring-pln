                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                        <div className="bg-white rounded-lg p-6 max-w-lg w-full mx-4">
                            ...
                            <div className="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                <p className="text-sm text-blue-800 font-semibold mb-2">📋 Format CSV yang Diperlukan:</p>
                                ...
                                <p className="text-xs text-blue-700 mt-2">
                                    ...
                                    ✅ Satu baris = 1 pembayaran untuk 1 pegawai di 1 bulan<br/>
                                    ✅ Support multi-tahun (2024, 2025, 2026, dst)<br/>
                            ...
                            <form onSubmit={handleImport}>
                                <div className="mb-4">
                                    ...
                                    <p className="text-xs text-gray-500 mt-1">
                                        Gunakan file: <strong>bfko_format_ideal.csv</strong> dari folder preproc/
                                    </p>
                                </div>
