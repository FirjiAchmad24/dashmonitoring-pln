                        ...
                        <form onSubmit={handleCSVImport} className="space-y-4">
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mt-1">
                                    Format: No,Booking ID,Name,Personnel Number,Trip Number,Origin,Destination,Trip Destination,Departure Date,Return Date,Duration,Payment,Transaction Type,Sheet,Status
                                </p>
                            </div>
