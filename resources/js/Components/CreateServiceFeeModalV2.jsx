...
export default function CreateServiceFeeModal({ isOpen, onClose, availableSheets = [] }) {
    ...
    const handleCSVUpload = (e) => {
        ...
        if (invalidFiles.length > 0) {
            setErrors({ csv: `Invalid files: ${invalidFiles.map(f => f.name).join(', ')}. Only CSV files allowed.` });
            return;
        }
        ...
        // Preview first file's first 5 rows
                    ...
                    {activeTab === 'manual' ? (
                        ...
                        <div className="p-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    <label className="block text-sm font-medium mb-2">Upload CSV Files * (Multiple files supported)</label>
                                    <input 
                                        type="file" 
                                        accept=".csv" 
                                    ...
                                    <label htmlFor="csv-upload"
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500 mt-1">CSV files only • Multiple files allowed</p>
                                        </div>
                                    </label>
